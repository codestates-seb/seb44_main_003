...
import MoveBtn from '@/components/common/button/MoveBtn';
import QuestionCard from '@/components/common/layout/QuestionCard';
import {
  questionList,
  genres,
  moveResultBtn,
  beehappy,
  beesad,
} from '@/components/main/recommendModal/QuestionData';
