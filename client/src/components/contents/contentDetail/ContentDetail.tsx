...
import Bookmark from '@/components/contents/bookmark/Bookmark';
import ContentDetailLoading from '@/components/contents/contentDetail/ContentDetailLoading';
import Recommend from '@/components/contents/recommend/Recommend';
