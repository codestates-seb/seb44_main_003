...
import MobileGenreModal from '@/components/mobile/MobileGenreModal';
...
function GenreButton() {
  ...
  const handleClickOutside = (e: MouseEvent) => {
    if (
      ...
      !(genreButtonRef.current as HTMLDivElement).contains(e.target as Node)
    ) {
      setIsOpen(false);
    }
  };
  ...
  return (
    <GenreButtonContainer ref={genreButtonRef}>
      <S_GenreButton
...
const S_GenreButton = styled.div<{ ismobile: string }>`
  display: flex;
  align-items: center;
