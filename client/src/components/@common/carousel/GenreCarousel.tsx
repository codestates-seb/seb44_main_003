...
import CarouselLoading from '@/components/@common/carousel/CarouselLoading';
import ItemCard from '@/components/@common/Itemcard/ItemCard';
import useGenreCarouselData from '@/queries/genreCarousel/useGenreCarouselData';
...
const GenreCarousel = ({
  ...
  const { isLoading, error, data, isSuccess } = useGenreCarouselData(
    genre,
    path
  );
